...
export class CmisSave {
        ...
        cmisSession.getObjectByPath('/lingo/en').then((res) => {
            ...
            cmisSession.createDocument(enFolder, '', {"cmis:objectTypeId": "D:cmiscustom:document", "cmis:name": translation.wordEn + '_' + translation.partOfSpeech}).then((res) => {
                ...
                cmisSession.getObjectByPath('/lingo/vn').then((res) => {
                    ...
                    cmisSession.createDocument(vnFolder, '', {"cmis:objectTypeId": "D:cmiscustom:document", "cmis:name": translation.wordVn + '_' + translation.partOfSpeech}).then((res) => {
